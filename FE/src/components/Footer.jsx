...
const Footer = () => {
  return (
    <Container>
        ...
        <Right>
            <Title>Contact</Title>
            <ContactItem><i className="fa-solid fa-location-dot" style={{marginRight:'10px'}}></i>THF I: 27 Đường D52, P. 12, Q. Tân Bình, TP. HCM | Thanh Hùng Futsal Store II: 32A THẠCH THỊ THANH, P. TÂN ĐỊNH, Q. 1, TP. HCM </ContactItem>
            <ContactItem><i className="fa-solid fa-phone" style={{marginRight:"10px"}}></i>Hotline: 0901 710 780 - 028 38429720</ContactItem>
            <ContactItem><i className="far fa-envelope" style={{marginRight:"10px"}}></i>contact@thanhunggmail.com</ContactItem>
